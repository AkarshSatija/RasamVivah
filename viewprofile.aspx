...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content">
        <div>
            ...
            <div class="xbox">
                ...
                <div id="divContactInfoHidden" runat="server">
                    <img src="images/lock.png" alt="" style="width: inherit; height: inherit;" />
                </div>
            </div>
            <div class="xbox">
                <div class="heading">
    ...
    <div class="login" style="top: 190px;">
        <div id="divprofFunc" runat="server" visible="false">
            <table width="100%" border="0">
                <tr id="trReqContact" runat="server">
                    <td>
                        <asp:LinkButton ID="lbtnReqContact" runat="server" Text="Request To Contact" OnClick="btnReqContact_Click" />
                    </td>
                </tr>
                <tr id="trRemCon" runat="server" visible="false">
                    <td>
                        <asp:LinkButton ID="lbtnRemCon" runat="server" Text="Remove Contact" OnClick="lbtnRemCon_Click" />
                    </td>
                </tr>
                <tr id="trCancelReq" runat="server" visible="false">
                    <td>
                        <asp:LinkButton ID="lbtnCancelReq" runat="server" Text="Cancel Request" OnClick="lbtnCancelReq_Click" />
                    </td>
                </tr>
                <tr id="trAccReq" runat="server" visible="false">
                    <td>
                        <asp:LinkButton ID="lbtnAccReq" runat="server" Text="Accept Request" OnClick="lbtnAccReq_Click" />
                    </td>
                </tr>
                <tr id="trDecReq" runat="server" visible="false">
                    <td>
                        <asp:LinkButton ID="lbtnDecReq" runat="server" Text="Decline Request" OnClick="lbtnDecReq_Click" />
                    </td>
                </tr>
                <%--<tr>
                    <td>
                        <asp:LinkButton ID="lbtnShortlist" runat="server" Text="Shortlist" />
                    </td>
                </tr>--%>
                <%--  
                <tr>
                    <td>
                        <asp:LinkButton ID="LinkButton2" runat="server" Text="Forward To Friend" />
                    </td>
                </tr>--%>
                <%-- <tr>
                    <td>
                        <asp:LinkButton ID="LinkButton4" runat="server" Text="Report Abuse/Filter" />
                    </td>
                </tr>--%>
            </table>
        </div>
        <div id="divloginNow" runat="server">
            <a href="javascript:redirectToLogin()">Login To Proceed</a>
        </div>
    </div>
