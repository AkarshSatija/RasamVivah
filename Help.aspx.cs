...
public partial class Helpform : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        mail.From = new MailAddress("");//Add user email id here
        mail.To.Add("info@rasamvivah.com");
        
        mail.IsBodyHtml = true;
        mail.Subject = "QueryForm";
        mail.Body = "<br><br>Query<br>" + "<b>Name:</b>" +tbname.Text + " <br/> <b>Email :</b>" + txtemail.Text + " ";
        SmtpClient smtp = new SmtpClient("smtp.gmail.com", 587);
        smtp.Credentials = new System.Net.NetworkCredential("", ""); smtp.EnableSsl = true;//Add user email id and pass here
