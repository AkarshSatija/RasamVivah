...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
   <div>
        ...
        <div class="content">
            <div class="notifblock" style="width: inherit;">
            
            <div runat="server" id="divbackend_notif"> 
            <ul><li><a href="verify.aspx" >Please Verify Your contact Info. Click Here to Verify!</a></li>
            </ul>
            </div>


                <asp:ListView ID="lvnotification" runat="server" DataKeyNames="id" DataSourceID="SqlDataSourceNotification">
                    ...
                    <ItemTemplate>
                        <li style="">
                            ...
                            <asp:Label ID="notif_textLabel" runat="server" Text='<%# Eval("notif_text") %>' />
                            &nbsp;at&nbsp;
                            <asp:Label ID="notif_timeLabel" runat="server" Text='<%# Eval("notif_time","{0: hh:mm tt on MMM d}") %>' />
                            <asp:Label ID="status_readLabel" runat="server" Visible="false" Text='<%# Eval("status_read") %>' />
                            <asp:Label ID="lbnotif_type" runat="server" Visible="false" Text='<%# Eval("notif_type") %>' />
                        </li>
                    </ItemTemplate>
                    <LayoutTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSourceNotification" runat="server" ConnectionString="<%$ ConnectionStrings:matrimonialConnectionString %>"
                    SelectCommand="SELECT TOP (5) * FROM notifications WHERE (user_id = @user_id) AND (status_read = '0') ORDER BY notif_time DESC">
                    <SelectParameters>
            ...
            <div class="xbox">
                <div class="heading">
                    About Me <a href="editdetails.aspx">
            ...
            <div class="xbox">
                <div class="heading">
                    About My Family <a href="editdetails1.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
            ...
            <div class="xbox">
                <div class="heading">
                    About My Occupation <a href="editdetails1.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
            ...
            <div class="xbox">
                <div class="heading">
                    Contact Info: <a href="editdetails.aspx">
                        <img style="float: right; height: 20px; width: 20px;" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
                    <asp:ListView ID="lvcontactInfo" runat="server" 
                        DataSourceID="SqlDataSourceContactInfo">
                        <EmptyDataTemplate>
                        ...
                        <ItemTemplate>
                            <table>
                               ...
                               <%-- <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="cityLabel" runat="server" Text='<%# p.getCity(Eval("country").ToString(),Eval("city").ToString(),Server.MapPath("xml//"))%>' />
                                    </td>
                                </tr>
                                --%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="countryLabel" runat="server" Text='<%# p.getTextXml(Server.MapPath("xml//country.xml"), "option", Eval("country").ToString()) %>' />
                                    </td>
                                </tr>
                                <%--<tr>
                                    <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceContactInfo" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:matrimonialConnectionString %>" 
            ...
            <div class="xbox">
                <div class="heading">
                    Basic Information <a href="editbasicdetails.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
                        ...
                        <ItemTemplate>
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="have_childrenLabel" runat="server" Text='<%# p.getTextXml(Server.MapPath("xml//children.xml"), "option", Eval("have_children").ToString())  %>' />
                                     ...
                                     <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lbProf_created" runat="server" Text='<%# p.getTextXml(Server.MapPath("xml//createprofile.xml"), "option", Eval("create_profile").ToString())  %>' />
                                        </td>
                                    </tr>
                                    <%--<tr>
                                        <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:matrimonialConnectionString %>"
                        SelectCommand="SELECT * FROM [p_details] WHERE ([id] = @id)">
                        <SelectParameters>
            ...
            <div class="xbox">
                <div class="heading">
                    Family Details <a href="editdetails1.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
            ...
            <div class="xbox">
                <div class="heading">
                    Religion and Ethnicity <a href="editdetails.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
            ...
            <div class="xbox">
                <div class="heading">
                    Education and Occupation <a href="editdetails1.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
                        ...
                        <ItemTemplate>
                            <span style="">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            Plan to work after marriage?:</td><td>
            ...
            <div class="xbox">
                <div class="heading">
                    Lifestyle and Attributes <a href="editdetails.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
            ...
            <div class="xbox">
                <div class="heading">
                    Astro/ Kundali Details <a href="editdetails3.aspx">
                        <img style="float: right; height: 20px; width: 20px" alt="" src="assets/img/edit.png" />
                    </a>
                </div>
                <div>
                    <asp:ListView ID="lv5" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource6"
                        > <%--OnItemDataBound="lv5_ItemDataBound"--%>
                        <EmptyDataTemplate>
                            <span>No data was returned.</span>
                        </EmptyDataTemplate>
                        <ItemTemplate>
                            <span style="">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            &nbsp;<asp:LinkButton ID="linkkundli" runat="server" Text="View Kundli" PostBackUrl="~/viewpdf.aspx"
                    ...
                    <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:matrimonialConnectionString %>"
                        ...
                        <SelectParameters>
                            <asp:SessionParameter DefaultValue="" Name="id" SessionField="id" Type="Int64" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
            </div>
